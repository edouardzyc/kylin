...
public class QueryUtilTest extends LocalFileMetadataTestCase {
    ...
    @Test
    public void testSQLTransfer() {
        // SUM({fn CONVERT(...)}) generated by PowerBI
        String sql = "select sum(  { fn  convert(\"LSTG_SITE_ID\", SQL_DOUBLE)}) from KYLIN_SALES group by LSTG_SITE_ID";
        String s = QueryUtil.massageSql(sql, "default", 0, 0, "DEFAULT");
