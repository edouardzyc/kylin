...
public class ITGlobalDictionaryBuilderTest extends HBaseMetadataTestCase {
    ...
    private void cleanup() {
        String BASE_DIR = KylinConfig.getInstanceFromEnv().getReadHdfsWorkingDirectory(null) + "/resources/GlobalDict" + dictionaryInfo.getResourceDir() + "/";
    ...
    public void testGlobalDictLock() throws IOException, InterruptedException {
        ...
        builder.init(dictionaryInfo, 0, KylinConfig.getInstanceFromEnv().getReadHdfsWorkingDirectory(null));
