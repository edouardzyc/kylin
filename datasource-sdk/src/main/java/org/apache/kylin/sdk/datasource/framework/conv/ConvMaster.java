...
public class ConvMaster {
    ...
    //    public String findTargetTypeName(TypeDef sourceTypeDef) {
    //        if (sourceDS == null || targetDS == null)
    //            return null;
    //
    //        List<TypeDef> validTypeDefs = sourceDS.getTypeDefsByName(sourceTypeDef.getName());
    //        if (validTypeDefs != null) {
    //            for (TypeDef typeDef : validTypeDefs) {
    //                if (typeDef.getMaxPrecision() >= sourceTypeDef.getDefaultPrecision()) {
    //                    TypeDef targetType = targetDS.getTypeDef(typeDef.getId());
    //                    return targetType.buildString(sourceTypeDef.getDefaultPrecision(), sourceTypeDef.getDefaultScale());
    //                }
    //            }
    //        }
    //        return null;
