...
public class DefaultAdaptor extends AbstractJdbcAdaptor {
    ...
    public String fixCaseSensitiveSql(String sql) {
        try {
            String orig = sql.toUpperCase();
            List<String> databases = listDatabasesWithCache();
            String category = "";
            for (String c : databases) {
                if (orig.contains(c.toUpperCase()+".")||orig.contains(c.toUpperCase()+'"')) {
                    sql = sql.replaceAll(c.toUpperCase(), c);
                    category = c;
                }
            }
            ...
            for (String table : tables) {
                ...
                if (orig.contains(table.toUpperCase() + ",") || orig.contains(table.toUpperCase() + " ")
                        || orig.contains(table.toUpperCase() + ")") || orig.endsWith(table.toUpperCase())
                        || orig.contains(table.toUpperCase() + "\r") || orig.contains(table.toUpperCase() + "\n")
                        || orig.contains(table.toUpperCase() + ".")) {
