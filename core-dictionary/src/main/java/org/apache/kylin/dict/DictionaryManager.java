...
public class DictionaryManager {
    ...
    public DictionaryInfo findLargestDictInfo(DictionaryInfo dictInfo) throws IOException {
        final ResourceStore store = getStore();
        final List<DictionaryInfo> allResources = store.getAllResources(dictInfo.getResourceDir(), DictionaryInfo.class,
                DictionaryInfoSerializer.INFO_SERIALIZER);
    ...
    public List<DictionaryInfo> sortLargestDictInfo(DictionaryInfo dictInfo) throws IOException {
        final ResourceStore store = getStore();
        final List<DictionaryInfo> allResources = store.getAllResources(dictInfo.getResourceDir(), DictionaryInfo.class,
                DictionaryInfoSerializer.FULL_SERIALIZER);
        Collections.sort(allResources, new Comparator<DictionaryInfo>() {
            @Override
            public int compare(DictionaryInfo o1, DictionaryInfo o2) {
