...
abstract public class KylinConfigBase implements Serializable {
    ...
    public boolean isGlobalDictionaryEnabled() {
        return Boolean.parseBoolean(getOptional("kylin.dictionary.global-dictionary-enabled", "false"));
    }
    ...
    public boolean isReplaceColCountWithCountStar() {
        return Boolean.valueOf(getOptional("kylin.query.replace-count-column-with-count-star", "true"));
    }
