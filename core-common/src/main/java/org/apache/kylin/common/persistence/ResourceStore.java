...
abstract public class ResourceStore {
    ...
    public static final String LOGHUB_RESOURCE_ROOT = "/loghub";
    ...
    public static final String PROJECT_DICT_VERSION_RESOURCE_ROOT = PROJECT_DICT_RESOURCE_ROOT + "/version_info";
