...
public class AdminServiceTest extends ServiceTestBase {
    ...
    public void testGetPublicConfig() throws IOException {
        ...
        String temp = "kylin.web.link-streaming-guide=http://kylin.apache.org/\n" +
        ...
        //String[] actual = controller.getPublicConfigV2("").data.toString().split("\n");
        String[] actual = adminService.getPublicConfig().split("\n");
        Arrays.sort(actual);
