...
public class CubeReducerTest extends LocalFileMetadataTestCase {
    ...
    public void testReducerOnlyAggrInBaseCuboid() throws Exception {
        ...
        Pair<Text, Text> p1 = new Pair<Text, Text>(new Text("72010ustech"),
                newValueText(codec, null, "10", "20.34", 3, 600));
        Pair<Text, Text> p2 = new Pair<Text, Text>(new Text("1tech"),
                newValueText(codec, null, "15.09", "20.34", 2, 1500));
        Pair<Text, Text> p3 = new Pair<Text, Text>(new Text("0"), newValueText(codec, null, "146.52", "146.52", 0, 0));
