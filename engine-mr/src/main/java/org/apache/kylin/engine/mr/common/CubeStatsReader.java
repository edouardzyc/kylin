...
public class CubeStatsReader {
    ...
    public CubeStatsReader(CubeSegment cubeSegment, KylinConfig kylinConfig, CubeStatsResult cubeStatsResult) throws IOException {
        this.seg = cubeSegment;
            ...
            for (String column : columns) {
                ...
                if (columnCardinality == null || columnCardinality < 0) {
                    if (sourceRowCount == 0) {
                        ...
                        return estimateTopNCountWithOutModelStats == 0 ? 1L : estimateTopNCountWithOutModelStats;
                    }
                }
            }
