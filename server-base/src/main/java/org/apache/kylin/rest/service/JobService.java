...
public class JobService extends BasicService implements InitializingBean {
    ...
    */
    ...
    /**
     * for api with accept header "application/json"
    ...
    /**
     * For rest api with accept header "application/vnd.apache.kylin-v2+json"
     ...
     *
     */
    public List<JobSearchResult> searchJobsByJobNameV2(final String jobName, final String projectName,
            final List<JobStatusEnum> statusList, final JobTimeFilterEnum timeFilter) {
        if (null == projectName) {
            aclEvaluate.checkIsGlobalAdmin();
        } else {
        ...
        return Lists
                .newArrayList(FluentIterable
                        .from(innerSearchCubingJobsV2(null, jobName, states, timeStartInMillis, timeEndInMillis,
