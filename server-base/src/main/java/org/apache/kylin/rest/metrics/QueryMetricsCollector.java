...
public class QueryMetricsCollector {
    ...
    private static final Logger logger = LoggerFactory.getLogger(QueryMetricsCollector.class);
    ...
    public static class QueryMetrics {
        ...
        private void collect(final SQLRequest request, final SQLResponse response, final QueryContext context) {
            ...
            if (logger.isDebugEnabled()) {
                logger.debug("Query[{}] collect metrics {}, {}, {}, {}, {}, {}, {}, {}, {}", queryId, sql, submitter,
                        project, hostname, suite, queryDuration, totalScanBytes, errorType, engineType);
            }
        }
        ...
        private void addRealizationMetrics(String realizationName, String realizationType, String modelName) {
            ...
            if (logger.isDebugEnabled()) {
                logger.debug("Query[{}] hit project [{}], model [{}], realization name [{}], realization type [{}]",
                        queryId, project, modelName, realizationName, realizationType);
            }
        }
